...
This asset enables you to implement Cloud SQL instance using Config Connector on Google Kubernetes Engine on the Google Cloud. 
...
Navigate to `https://console.cloud.google.com/iam-admin/serviceaccounts?authuser=2&cloudshell=false&project={{project-id}}` to explore service accounts in the console.

Navigate to `https://console.cloud.google.com/kubernetes/config?authuser=2&cloudshell=false&project={{project-id}}` to explore secrets in the console.
...
Navigate to `https://console.cloud.google.com/sql/instances?authuser=2&cloudshell=false&project={{project-id}}` to explore the database in the console.
